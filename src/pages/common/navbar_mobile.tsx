            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-8 bg-black preview-box rounded-lg " style="height:200px"></div>
                        <div class="col-lg-2"></div>
    ...
    const checkOutDetails = () => {
        return <div>
            ...
            <div class="ml-3 row justify-content-centre align-items-centre">
                <div class="col-lg-3 check-out-item-border py-3 text-uppercase  text-center justify-content-center align-content-center"><h6 class="text-dark">mpesa</h6></div>
                <div class="col-lg-1 mx-1"></div>
                <div class="col-lg-3 check-out-item-border py-3 text-uppercase  text-center  justify-content-center align-content-center"><h6 class="text-dark">card</h6></div>
                <div class="col-lg-1 mx-1"></div>
                <div class="col-lg-3 check-out-item-border py-3 text-uppercase  text-center justify-content-center align-content-center"><h6 class="text-dark">cash</h6></div>
            </div>
            <div class="my-4"/>
        </div>
    }
...

                    {
                        showCheckOut() ? <></> :
                            <div class="float-right">
                                ...
                                &nbsp;
                                {showCheckOut() ? <></> :
                                    <Button style="#87674F" class="bg-dark modal-back-color border-0" onClick={(e) => {
                                        if (showCheckOut()) {
                                            handleClose()
                                        } else {
